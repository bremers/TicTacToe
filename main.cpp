...
//Original tutorial from https://www.stechies.com/tic-tac-toe-cpp/
//Updated by bremers to fix formatting issues
//Dec 13, 2020
...
void player_turn(){
    ...
    if(turn == 'X' && board[row][column] != 'X' && board[row][column] != 'O'){
        ...
        cout<<"Box already filled!n Please choose another!!"<<endl<<endl;
        player_turn();
    }
    /* Ends */
    display_board();
...
int main()
{
    std::cout<<endl<<"\t\t\tT I C K -- T A C -- T O E -- G A M E\t\t\t"<<endl;
    std::cout<<endl<<"\t\t\t\tFOR 2 PLAYERS\t\t\t"<<endl;
    while(gameover()){
        display_board();
        player_turn();
        gameover();
